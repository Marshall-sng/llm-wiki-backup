...
Phase 4 将已提取的确定性证据转成 `generation-instruction.md` 中的“画像约束”：

- DOCX：章节模式、候选标题样例、段落样式频率、编号线索、字体字号线索、页面线索。
- XLSX：工作表线索和表格化/指标化生成策略。
- PPTX：页数/版式线索和逐页汇报生成策略。
- PDF：页面/文本层线索和低保真参考边界。
